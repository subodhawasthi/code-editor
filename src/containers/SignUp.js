      ...
      await signInWithEmailAndPassword(auth, email, password)
        ...
        .catch((err) => {
          ...
          if (err.message.includes("user-not-found")) {
            ...
            setAlert(true);
            setAlertMssg("Invalid Credential!");
          } else {
            setAlert(true);
            setAlertMssg("Temporarily disabled due to many failed Logins");
          }
        ...
        <div className=" px-8 w-full md:w-auto py-4 rounded-xl bg-secondary shadow-md flex flex-col items-center justify-center gap-6">
          ...
          {!isLogin ? (
            <motion.div
              ...
              whileTap={{ scale: 0.9 }}
              className="flex items-center justify-center w-full py-3 rounded-xl hover:bg-emerald-400 cursor-pointer bg-emerald-300"
            >
